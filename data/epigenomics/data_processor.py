...
class EpigenomicsDataProcessor:
    ...
    def extract_features(self, data):
        ...
        features = data[['chromosome', 'position']]
        return features

    def extract_labels(self, data):
        logger.info("Extracting labels")
        labels = data['methylation_level']
        return labels

    def create_feature_matrix(self, data):
        logger.info("Creating feature matrix")
        feature_matrix = pd.get_dummies(data[['chromosome', 'position']])
        return feature_matrix

    def create_label_vector(self, data):
        logger.info("Creating label vector")
        label_vector = data['methylation_level']
        return label_vector
